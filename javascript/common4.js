	/*
		common4.js
		Copyright 2005-6 Michael Pritchard
	...
	*/
	...
	{
		var pre = '<img src="http://cricket.eppe.co.uk/images/searching.gif" alt="Loading" />&nbsp;';
		ShowMessage(pre + msg);
	}	
	
	function ShowMessage(msg)
	{
		var lo			= document.getElementById("statusBarText");
		lo.innerHTML 	= msg;
	}
	
	function ShowCopyText(msg)
	{
		var lo			= document.getElementById("copyrightInfoText");
		lo.innerHTML 	= msg;
	}
	...
	{
		var info		= document.getElementById("extraInfoBox");
	...
	{
		var info		= document.getElementById("searchBox");
		info.className 	= 'extraInfoText';
...
/* RELOAD TRAFFIC STUFF */
	...
	{
		var request 	= GXmlHttp.create();
		var url			= main_site + 'includes/rail.php?ldb='+code;
