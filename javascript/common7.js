/*
common7.js
Copyright 2005-11 Michael Pritchard
http://bbc.blueghost.co.uk/site7.php
...
function SetupTraffic() {
    HideExtraInfoBox();
    var html = 'Data from Highways Agency - http://www.highways.gov.uk/';
    ShowCopyText(html);
...
function SetupWeather() {
    HideExtraInfoBox();
    var html = 'Weather data provided by <a href="http://www.weather.com/?prod=xoap&par=' + weatherId + '" title="Go to weather.com" target="_blank">weather.com ®</a>';
    ShowCopyText(html);
}