...
//<![CDATA[
	...
	{
		HideExtraInfoBox();
		var html 	= 'Weather data provided by <a href="http://www.weather.com/?prod=xoap&par=<?php echo $partnerID;?>" title="Go to weather.com" target="_blank">weather.com &reg;</a>';
		ShowCopyText(html);
	}
