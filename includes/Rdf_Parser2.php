<?php
	...
	class Rdf_Parser2 extends XML_Parser{
		var $image;
 		var $javaOP;
  		var $combo;
  		var $base_url;
  		...
  		function parseFile(){
    		...
    		foreach ($items as $item){
				...
				$this->output		.= "\t\t<div class=\"news_source_data_item\">\n";
				$this->output 		.= "\t\t\t<a href=\"" . $item["link"] . "\" target=\"_blank\">" . $item["title"] ."</a>\n";
				$this->output		.= "\t\t\t<div class=\"news_source_data_description\">".strip_tags($item["description"])."</div>\n";
				$this->output		.= "\t\t</div>\n";
	  			$c++;
    		}
