...
<div id="selector">
	...
	<div id="up" class="choiceU" 	title="Click here to load the latest version of this site" onmouseover="javascript:highlight('up', 'choiceHU');" onmouseout="unhighlight('up', 'choiceU');" 	onclick="javascript:document.location.href='http://bbc.blueghost.co.uk/?sidebar=y';">Update Available</div>
